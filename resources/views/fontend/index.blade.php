							...
							<div class="owl-carousel owl-theme deals_slider">
								...
								@foreach($product_random as $product_random)
									<div class="owl-item deals_item">
										<div class="deals_image"><img src="/{{$product_random->image}}" alt=""></div>
										<div class="deals_content">
											<div class="deals_info_line d-flex flex-row justify-content-start">
												<div class="deals_item_category"><a href="#">{{$product_random->category->name}}</a></div>
												<div class="deals_item_price_a ml-auto">{{$product_random->origin_price}}đ</div>
											</div>
											<div class="deals_info_line d-flex flex-row justify-content-start">
												<div class="deals_item_name">{{$product_random->name}}</div>
												<div class="deals_item_price ml-auto">{{$product_random->sale_price}}đ</div>
											</div>
											<div class="available">
						...
						<div class="tabbed_container">
							...
							<div class="product_panel panel active">
								<div class="featured_slider slider">
									...
									<!-- Slider Item -->
									@foreach($product_dacsac as $product)
											...
											<div class="featured_slider_item">
												...
												<div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
													...
													<div class="product_content">
														<div class="product_price is_new">{{$product->sale_price}}<span>{{$product->origin_price}}</span></div>
														...
														<div class="product_extras">
															...
															<a href="{{route('fontend.cart.add', $product->id)}}"><button class="product_cart_button">Add to Cart</button></a>
														</div>
													</div>
							...
							<div class="product_panel panel">
								<div class="featured_slider slider">
									...
									<!-- Slider Item -->
									@foreach($product_giamgia as $product_giamgia)
										<div class="featured_slider_item">
											<div class="border_active"></div>
											<a href="{{route('fontend.pages.product', $product_giamgia->id)}}">
												<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
													<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="/{{$product_giamgia->image}}" alt=""></div>
													<div class="product_content">
														<div class="product_price discount">{{$product_giamgia->sale_price}}<span>{{$product_giamgia->origin_price}}</span></div>
														<div class="product_name"><div><a href="product.html">{{$product_giamgia->name}}</a></div></div>
														<div class="product_extras">
															<div class="product_color">
																<input type="radio" checked name="product_color" style="background:#b19c83">
																<input type="radio" name="product_color" style="background:#000000">
							...
							<div class="product_panel panel">
								<div class="featured_slider slider">
									...
									<!-- Slider Item -->
									@foreach($product_banchay as $product_banchay)
										<div class="featured_slider_item">
											<div class="border_active"></div>
											<a href="{{route('fontend.pages.product', $product_banchay->id)}}">
												<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
													<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="/{{$product_banchay->image}}" alt=""></div>
													<div class="product_content">
														<div class="product_price discount">{{$product_banchay->sale_price}}<span>{{$product_banchay->origin_price}}</span></div>
														<div class="product_name"><div><a href="product.html">{{$product_banchay->name}}</a></div></div>
														<div class="product_extras">
															<div class="product_color">
																<input type="radio" checked name="product_color" style="background:#b19c83">
																<input type="radio" name="product_color" style="background:#000000">
